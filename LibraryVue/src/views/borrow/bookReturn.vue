  ...
  <el-main>
    ...
    <el-form :model="listParm" label-width="80px" :inline="true">
      ...
      <el-form-item>
        ...
        <el-button type="primary" @click="returnBtn"> 批量还书
        </el-button>
      </el-form-item>
    </el-form>
    <!-- 表格 -->
    <el-table ref="tables" :height="tableHeight" :data="tableData" border stripe>
      ...
      <el-table-column prop="borrowStatus" label="借书状态" align="center" width="100">
        <template slot-scope="scope">
          ...
          <el-tag v-if="scope.row.borrowStatus == '2'" type="success">已还
          </el-tag>
          <el-tag v-if="scope.row.borrowStatus == '3'" type="danger">拒绝
          </el-tag>
        </template>
      </el-table-column>
      ...
      <el-table-column label="操作" fixed="right" width="340">
        <template slot-scope="scope">
          <span class="span-button-text" @click="alongReturnBtn(scope.row)"> 还书</span>
          <span class="span-button-text" @click="ExceptioReturnBtn(scope.row)"> 异常还书</span>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    ...
    <sys-dialog :title="dialog.title" :width="dialog.width" :height="dialog.height" :visible="dialog.visible"
      ...
      <div slot="content">
        <el-form ref="exceptionRef" :model="exception" :rules="rules" label-width="80px">
          ...
          <el-form-item prop="excepionText" label="备注">
            <el-input v-model="exception.excepionText" type="textarea" />
          </el-form-item>
        </el-form>
      </div>
    </sys-dialog>
