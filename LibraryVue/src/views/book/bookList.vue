<template>
  <el-main>
    ...
    <el-form :model="listParm" :inline="true">
      ...
      <el-form-item>
        <el-input v-model="listParm.bookName" placeholder="请输入图书名称" />
      </el-form-item>
      <el-form-item>
        <el-input v-model="listParm.bookPlaceNum" placeholder="请输入书架号" />
      </el-form-item>
      <el-form-item>
        <el-input v-model="listParm.bookAuther" placeholder="请输入作者" />
      </el-form-item>
      <el-form-item>
        <el-button @click="searchBtn"> 查询</el-button>
        <el-button style="color: #ff7670" @click="resetBtn"> 重置
        </el-button>
        <el-button v-permission="['sys:bookList:add']" type="primary" @click="addBtn"> 新增
        </el-button>
      </el-form-item>
    </el-form>
    <!-- 表格 -->
    <el-table :height="tableHeight" :data="tableData" border stripe>
      ...
      <el-table-column label="操作" fixed="right" width="260">
        <template slot-scope="scope">
          <span class="span-button-text" v-permission="['sys:bookList:edit']" type="primary" @click="editBtn(scope.row)">编辑</span>
          <span class="span-button-text" v-permission="['sys:bookList:delete']" type="danger" @click="deleteBtn(scope.row)"> 删除</span>
        </template>
      </el-table-column>
    </el-table>
    <!-- 分页 -->
    <el-pagination :current-page.sync="listParm.currentPage" :page-sizes="[10, 20, 40, 80, 100]"
    ...
    <sys-dialog :title="dialog.title" :height="dialog.height" :width="dialog.width" :visible="dialog.visible"
      ...
      <div slot="content">
        <el-form ref="addRef" :model="addModel" :rules="rules" label-width="80px" style="margin-right: 10px">
