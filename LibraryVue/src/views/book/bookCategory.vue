<template>
  ...
  <el-main>
    ...
    <el-form :model="listParm" label-width="80px" :inline="true">
      <el-form-item>
        <el-input v-model="listParm.categoryName" placeholder="请输入类型名称" />
      </el-form-item>
      <el-form-item>
        <el-button @click="searchBtn"> 搜索</el-button>
        <el-button style="color: #ff7670" @click="resetBtn"> 重置
        </el-button>
        <el-button v-permission="['sys:bookCategory:add']" type="primary" @click="addBtn"> 新增
        </el-button>
      </el-form-item>
    </el-form>
    <!-- 表格 -->
    <el-table :height="tableHeight" :data="tableData" border stripe>
      ...
      <el-table-column label="操作" fixed="right" width="260">
        <template slot-scope="scope">
          <span class="span-button-text" v-permission="['sys:bookCategory:edit']" type="primary" @click="editBtn(scope.row)">
            编辑
          </span>
          <span class="span-button-text" v-permission="['sys:bookCategory:delete']" type="danger" @click="deleteBtn(scope.row)">
            删除
          </span>
        </template>
      </el-table-column>
    ...
    <sys-dialog :title="dialog.title" :width="dialog.width" :height="dialog.height" :visible="dialog.visible"
      ...
      <div slot="content">
        <el-form ref="addRef" :model="addModel" :rules="rules" label-width="80px" style="margin-right: 15px">
